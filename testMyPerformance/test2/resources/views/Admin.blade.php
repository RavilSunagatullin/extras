    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg" >
                <div class="p-6 text-gray-900 dark:text-gray-100" style="display: grid; grid-template-columns: 200px 200px 200px 200px 200px; align-items: center; gap: 20px">
                    <x-dropdown-link :href="route('book.create')" style="border-radius: 8px;">
                        {{ __('Create book') }}
                    </x-dropdown-link>
                   <p>
                      Число книг: {{count($books)}}
                   </p>
                    <p>
                        Другая ифнормация
                    </p>
